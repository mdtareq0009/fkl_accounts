...
<table width="100%">
	<tr>	
		...
		<td>
			...
			<!-- performance table -->		
			<table id="tblSample_pic" style="width:98%;border-color: white" border="1" class="input-small table row-border cell-border table-reiv" >
                            <thead>
                                <th class="input-small text-center">SL</th>
						...
						<tr>
							...
							<td>
                                ...
                                <img id="blah0" alt="your image" width="150" height="100" />
                            </td>
