                ...
                <div class="content-wrapper" id="categories">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <ol class="breadcrumb float-sm-left">
                                        ...
                                        <li class="breadcrumb-item active" style="color: #ffdc2f;">Color</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="content">
                        <div class="container-fluid">
                            ...
                            if ($_GET['page'] == 'all-colors'):
                                if ($auth->verifyUserPermission('checked', 'color') 
                                        ...
                                        <div class="col-md-12 col-lg-4 offset-lg-4">
                                            <div class="card card-secondary pt-2">
                                                <div class="card-header p-2">
                                                    <h3 class="card-title">Color Entry</h3>
                                                </div>
                                                <form id="dataForm">
                                                    <div class="card-body p-2" id="brand">
                                                        <div class="form-group">
                                                            <label for="vname">Color Name</label>
                                                    ...
                                                    <table id="example2" class="table table-bordered table-striped example1">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <?php if ($auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin') || ($auth->verifyUserPermission('checked', 'color_edit') == true) || ($auth->verifyUserPermission('checked', 'color_del') == true)) { ?>
                                                                    <th>Action</th>
                                                                <?php } ?>
                        ...
                        $('#dataForm').on('submit', function(e) {
                           ...
                           let  types = {
                            ...
                            if (types.V_NAME == '' || types.V_NAME == null) {
                                Toast.fire({
                                            icon: 'info',
                                            title: 'Please Enter a Color name'
                                })
                                return;
                            }

                            let url = 'action/curd-action.php';
                            let quaryType = 'add-colors';

                            if (types.N_ID != '') {
                                quaryType = 'edit-colors';
                            }
                                ...
                                res.forEach((row, sl) => {
                                    const row1 = `<tr data-id="${row.N_ID}">
                                            ...
                                            <td>${row.UPDATEDUSER}</td>
                                             <td align="center">
                                             <?php if ($auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin') || ($auth->verifyUserPermission('checked', 'color_edit') == true)) { ?>
                                                ...
                                                <?php  } ?>
                                                <?php if ($auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin') || ($auth->verifyUserPermission('checked', 'color_del') == true)) { ?>
