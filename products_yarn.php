                                                ...
                                                <form id="dataForm">
                                                        ...
                                                        <div class="card-body p-2 row" id="brand">
                                                            <div class="col-md-6 col-lg-6">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="vproductcode" class="col-sm-3 col-form-label">Brand</label>
                                                                    <div class="col-11 col-sm-8">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="vname" class="col-sm-3 col-form-label">Product Name</label>
                                                                    <div class="col-sm-9">
                                                                        <input type="text" id="vname" class="form-control form-control-sm form-control-border v_name"  placeholder="Enter Product Name" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-lg-6">
                                                                <div class="form-group row">
                                                                    <label for="vproductcode" class="col-sm-3 col-form-label">Unit</label>
                                                                    <div class="col-11 col-sm-8">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-sm-3 col-form-label">Openeing Stock</label>
                                                                    <div class="col-sm-9">
                                                                    <input type="number" id="vname" class="form-control form-control-sm form-control-border opening_stock" placeholder="Enter Openeing Stock" />
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label for="vname" class="col-sm-3 col-form-label">Description</label>
                                                                    <div class="col-sm-9">
                                                                        <textarea name="vname" id="vname" class="form-control form-control-sm  form-control-border note" placeholder="Enter Note"></textarea>
                                                                    </div>
                                                                </div>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $('#dataForm').on('submit', function(e) {
                           ...
                           let  types = {
                            ...
                            if (types.V_PRODUCT_NAME == '' || types.V_PRODUCT_NAME == null) {
                                Toast.fire({
                                            icon: 'info',
                            ...
                            if (types.N_UNIT_ID == '' || types.N_UNIT_ID == null) {
                                Toast.fire({
                                            icon: 'info',
                            ...
                            if (types.N_CATEGORY_ID == '' || types.N_CATEGORY_ID == null) {
                                Toast.fire({
                                            icon: 'info',
                            ...
                            if (types.N_BRAND_ID == '' || types.N_BRAND_ID == null) {
                                Toast.fire({
                                            icon: 'info',
                            ...
                            let url = 'action/products-action.php';
                            let quaryType = 'add-products';

                            if (types.N_ID != '') {
                                quaryType = 'edit-products';
                            }
                    ...
                    function editType(data) {
                        const rowData = JSON.parse(decodeURIComponent(data.getAttribute('data-row')));
                            console.log(rowData);
                        $('#brand .product_code').val(rowData.V_PRODUCT_CODE); 
                        $('#brand .v_name').val(rowData.V_PRODUCT_NAME); 
                        $('#brand .note').val(rowData.V_NOTE);
                        ...
                        $('#brand .opening_stock').val(rowData.OPENING_STOCK); 
