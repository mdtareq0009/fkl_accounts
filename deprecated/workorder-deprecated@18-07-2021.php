...
<body class="m4-cloak h-vh-100">
    ...
    <div data-role="navview" data-toggle="#paneToggle" data-expand="xxl" data-compact="xl" data-active-state="true">
        ...
        <div class="navview-content h-100">
                ...
                <div class="row border-bottom bd-lightGray pl-1 mr-1 ribbed-lightGray" style="margin-left: 0px;">
                    ...
                    <div class="cell-md-8">
                        ...
                        <?php
                            ...
                            <?php
                            elseif($_GET['page'] == 'copy'): ?>
                                <a href="javscript:void(0)" class="image-button workorder-submit success bg-orange bg-darkOrange-hover place-right-md mr-2-md border bd-dark-hover" data-type="draft" style="height: 22px;">
                                    <span class='mif-spinner icon' style="height: 22px; line-height: 22px; font-size: .9rem; width: 23px;"></span>
                                    <span class="caption text-bold">Publish Later (Draft)</span>
                                </a>
                                <a href="javscript:void(0)" data-type="publish" class="image-button workorder-submit success place-right-md mr-2-md border bd-dark-hover" style="height: 22px;">
                                    <span class='mif-plus icon' style="height: 22px; line-height: 22px; font-size: .9rem; width: 23px;"></span>
                                    <span class="caption text-bold">Publish Work Order</span>
                                </a>
                            <?php
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="cell-sm-6 cell-md-4 accessories-content-hidden content-visible">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" data-role="input" disabled class="input-small accessories-disable required-field form-name" name="form" placeholder="Enter Name" value="<?=$userInfo['name']?>">
            ...
            <div class="row-fluid">
                <div class="cell-md-12">
                    <div data-role="panel" data-title-caption="Accepted Work Order" data-collapsible="false" data-title-icon="<span class='mif-done_all'></span>">
                        <div class="ml-1 mr-1">
                             <div class="row">
                                 <div class="cell-sm-12 cell-md-7">
                                    <form action="" method="GET">
            ...
            elseif($_GET['page'] == 'details'):
                ...
                if($pageOpt->currentPageClass() == 'drafts'):
                    $edit = 4;
                    $delete = 5;
                    $rollback = 0;
                    $approve = 0;
                    $accepted = 0;
                    $conditionalPage = 'draft workorder';
                elseif($pageOpt->currentPageClass() == 'published'):
                    $print = 6;
                    $edit = 4;
                    $delete = 5;
                    $rollback = 10;
                    $approve = 7;
                    $accepted = 0;
                    $conditionalPage = 'publish workorder';
                elseif($pageOpt->currentPageClass() == 'approved'):
                    $print = 6;
                    $edit = 0;
                    $delete = 0;
                    $rollback = 10;
                    $approve = 0;
                    $accepted = 8;
                    $conditionalPage = 'approved workorder';
                elseif($pageOpt->currentPageClass() == 'accepted'):
                    $edit = 0;
                    $print = 6;
                    $delete = 0;
                    $rollback = 0;
                    $approve = 0;
                    $accepted = 0;
                    $conditionalPage = 'accepted workorder';
                elseif($pageOpt->currentPageClass() == 'all-work-order'):
                    $print = 6;
                    $edit = 4;
                    $delete = 5;
                    $rollback = 0;
                            ...
                            <div class="row">
                                <div class="cell-md-10">
                                    <div class="d-flex flex-justify-end" style="margin-top: -9px;">
                                        ...
                                        <?php if($masterData[0]['VSTATUS'] == 'draft'): ?>
                                        <div class="text-left pl-1 pr-1">
                                            <a class="image-button info" href="reports/draft/workorder/<?=$masterData[0]['NID']?>" target="_blank" style="height: 22px; padding: 1px 35px 1px 0px;"><span class="mif-printer icon" style="height: 22px; line-height: 22px; font-size: .9rem; width: 20px;"></span><span class="caption" style="margin-left: 2px;">Print</span></a>
                                        </div>
                                        <?php endif; ?>
                                        <?php if($masterData[0]['VSTATUS'] == 'publish' && $masterData[0]['NISSUESTATUS'] == 1 && ($auth->verifyUserPermission($conditionalPage, $print) == true || ucwords($userInfo['role']) == 'Super Admin')): ?>
                                        <div class="text-left pl-1 pr-1">
                                        ...
                                        <?php endif; ?>
                                        <?php if($masterData[0]['NAPPROVEDSTATUS'] == 0 && $masterData[0]['NISSUESTATUS'] == 1 && ($auth->verifyUserPermission($conditionalPage, $edit) == true || ucwords($userInfo['role']) == 'Super Admin')): ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if($masterData[0]['VSTATUS'] == 'publish' && $masterData[0]['NACCEPTENCESTATUS'] == 0 && $masterData[0]['NAPPROVEDSTATUS'] == 1 && $masterData[0]['NISSUESTATUS'] == 1 && ($auth->verifyUserPermission($conditionalPage, $rollback) == true || ucwords($userInfo['role']) == 'Super Admin')): ?>
                                        <div class="text-left pl-1 pr-1">
                                        ...
                                        <?php endif; ?>
                                        <?php if($masterData[0]['VSTATUS'] == 'publish' && $masterData[0]['NACCEPTENCESTATUS'] == 0 && $masterData[0]['NAPPROVEDSTATUS'] == 0 && $masterData[0]['VISSUE'] == 1 && ($auth->verifyUserPermission($conditionalPage, $rollback) == true || ucwords($userInfo['role']) == 'Super Admin')): ?>
                                        <div class="text-left pl-1 pr-1">
                                        ...
                                        <?php endif; ?>
                                        <?php if($masterData[0]['NAPPROVEDSTATUS'] == 0 && $masterData[0]['NISSUESTATUS'] == 1 && ($auth->verifyUserPermission($conditionalPage, $delete) == true || ucwords($userInfo['role']) == 'Super Admin')): ?>
                                        <div class="text-center pl-1 pr-1">
                                    ...
                                    <!-- id="printJS-form" ondblclick="printJS({ printable: 'printJS-form', type: 'html', maxWidth : 1920, css: ['vendor/metro4/css/metro-all.min.css', 'css/index.css', 'css/custom-style.css'], targetStyles: ['*'], scanStyles : false,  documentTitle :'Work Order'})" -->
                                ...
                                <div class="cell-md-2 bd-light border bg-white">
                                    ...
                                    <div class="workorder-progress-bar">
                                        <ol class="steps">
                                            ...
                                            <?php
                                            if($auth->verifyUserPermission($conditionalPage, $approve) == true || ucwords($userInfo['role']) == 'Super Admin'): 
                                            ?>
                                                <button class="image-button success" type="button" onclick="workorderManualUpdate('approved', <?=$id?>);" style="height: 22px; padding: 0 2px 0 0;"><span class="mif-done icon" style="height: 22px; line-height: 22px; font-size: .9rem; width: 20px;"></span><span class="caption" style="margin-left: 2px;">Approve</span></button>
                                            <?php
                                            endif;
                                            ?>
                                            </li>
                                            ...
                                            <?php
                                            if($auth->verifyUserPermission($conditionalPage, $accepted) == true || ucwords($userInfo['role']) == 'Super Admin'): 
                                            ?>
                                                <button class="image-button success" type="button" onclick="workorderManualUpdate('accepted', <?=$id?>);" style="height: 22px; padding: 0 2px 0 0;"><span class="mif-done_all icon" style="height: 22px; line-height: 22px; font-size: .9rem; width: 20px;"></span><span class="caption" style="margin-left: 2px;">Accept</span></button>
                                            <?php
                                            endif;
                                            ?>
                                            </li>
                                            ...
                                            <table class="subcompact cell-border bg-white table searchordertable " style="margin-top: 0.5rem; margin-bottom: 0.5rem;">
                                                <tr>
                                                    <td style="padding: 0px;">
                                                        ...
                                                        <span class="" style="<?=(strtolower($masterData[0]['VTYPE']) == 'fkl number' ? 'display: none;' : 'display: block;')?>"><span class="text-bold searchLabel">FKL NO.</span> <span id="fklno"><?=strtolower($masterData[0]['VORDERNUMBERORFKLNUMBER']) == 'block' ? "<input type='text' class='fklno-input input-small' style='max-width: 150px; display: inline;' value='".$fklNumber."'>" : $fklNumber;?></span></span><span class="" style="<?=(strtolower($masterData[0]['VTYPE']) == 'order number' ? 'display: none;' : 'display: block;')?>"><span class="text-bold searchLabel">ORDER NO.</span> <span id="ordernumber"><?=strtolower($masterData[0]['VORDERNUMBERORFKLNUMBER']) == 'block' ? "<input type='text' class='ordernumber-input input-small' style='max-width: 150px; display: inline;' value='".$orderNumber."'>" : $orderNumber;?></span></span></td>
                                                    <td style="padding: 0px;"><span class="text-bold searchLabel">Style Name</span> <span id="stylename"><?=strtolower($masterData[0]['VORDERNUMBERORFKLNUMBER']) == 'block' ? "<input type='text' class='stylename-input input-small' style='max-width: 150px; display: inline;' value='".$orderInfo[0]['STYLENAME']."'>" : $orderInfo[0]['STYLENAME'];?></span></td>
                                                    <td style="padding: 0px;"><span class="text-bold searchLabel">Buyer Name</span> <span id="buyername"><?=strtolower($masterData[0]['VORDERNUMBERORFKLNUMBER']) == 'block' ? "<input type='text' class='buyername-input input-small' style='max-width: 150px; display: inline;' value='".$orderInfo[0]['BUYERNAME']."'>" : $orderInfo[0]['BUYERNAME'];?></span></td>
                                                    
                                                </tr>
                                                <tr>
                                                    <td style="padding: 0px;"><span class="text-bold searchLabel">Season</span> <span id="season"><?=strtolower($masterData[0]['VORDERNUMBERORFKLNUMBER']) == 'block' ? "<input type='text' class='season-input input-small' style='max-width: 150px; display: inline;' value='".$orderInfo[0]['VSEASSONNAME']."'>" : $orderInfo[0]['VSEASSONNAME'];?></span></td>
                                                    <td style="padding: 0px;"><span class="text-bold searchLabel">Dept.</span> <span id="dept"><?=strtolower($masterData[0]['VORDERNUMBERORFKLNUMBER']) == 'block' ? "<input type='text' class='dept-input input-small' style='max-width: 150px; display: inline;' value='".$orderInfo[0]['VDEPTNAME']."'>" : $orderInfo[0]['VDEPTNAME'];?></span></td>
                                                    <td style="padding: 0px;"><span class="text-bold searchLabel">Kimball</span> <span id="kimble"><?=strtolower($masterData[0]['VORDERNUMBERORFKLNUMBER']) == 'block' ? "<input type='text' class='kimble-input input-small' style='max-width: 150px; display: inline;' value='".$orderInfo[0]['KIMBALLNO']."'>" : $orderInfo[0]['KIMBALLNO'];?></span></td>
                                                    <!-- <td style="padding-left: 0px;"><span class="text-bold searchLabel">Gmts Qty</span> <span id="qty"></span><input type="hidden" name="gmtqty" class="gmtqty required-field" value=''><span class="invalid_feedback">Garments qty is required.</span></td> -->
                                                </tr>
                                            </table>
                                        </div>
                                            ...
                                            */
                                            ...
                                            <table class="subcompact cell-border table searchordertable" style="margin-top: 0.5rem; margin-bottom: 0.5rem;">
                                                <tr>
                                                    ...
                                                    array_push($parameters, 'Garments Qty (Size)');
                                                    ...
                                                    foreach ($parameters as $key => $options):
                                                        ...
                                                        elseif(trim(strtolower($options)) == 'garments qty (size)'):
                                                            
                                                            $cellData2 .= "<input type='checkbox' data-role='checkbox' value='".trim($options)."' data-parentid='".$getItemId."' data-cls-checkbox='mr-1 ml-1 mt-1 bg-darkCyan mb-1 p-1 border  bd-white rounded fg-white parameters-disabled parameters parameters-groupcommon ".preg_replace("/^'|[^A-Za-z0-9\'-]|'$/", "-", strtolower(trim(str_replace('(', '',$options))))."' data-caption='".trim($options)."' data-cls-check='bd-white myCheck'>";
                                                        else:
                                                ...
                                                <tr>
                                                    ...
                                                    foreach ($parameters as $key => $options):
                                                        ...
                                                        elseif(trim(strtolower($options)) == 'addition'):
                                                            ...
                                                            elseif((in_array('Color Wise Qty', $checkedOption) == true || in_array('Color & Size Wise Qty', $checkedOption) == true || in_array('Kimball/Color/Size Wise Qty', $checkedOption) == true || in_array('Size Wise Qty', $checkedOption) == true || in_array('Kimball & Color Wise Qty', $checkedOption) == true || in_array('Garments Qty', $checkedOption) == true || in_array('Garments Qty (Size)', $checkedOption) == true) && $item['NEXCELUPLOAD'] != 1):
                                                                $cellData3 .= "<input type='checkbox' data-role='checkbox' value='".trim($options)."' data-parentid='".$getItemId."' data-cls-checkbox='mr-1 ml-1 mt-1 mb-1 p-1 border bg-crimson rounded bd-white addition-enable fg-white parameters ".preg_replace("/^'|[^A-Za-z0-9\'-]|'$/", "-", strtolower(trim($options)))."' data-caption='".trim($options)."'>";
                                                            else:
                                                        ...
                                                        elseif(trim(strtolower($options)) == 'garments qty'):
                                                            ...
                                                            elseif(in_array('Color Wise Qty', $checkedOption) == false && in_array('Color & Size Wise Qty', $checkedOption) == false && in_array('Kimball/Color/Size Wise Qty', $checkedOption) == false && in_array('Size Wise Qty', $checkedOption) == false && in_array('Kimball & Color Wise Qty', $checkedOption) == false && in_array('Garments Qty (Size)', $checkedOption) == false):
                                                                $cellData2 .= "<input type='checkbox' data-role='checkbox' value='".trim($options)."' data-parentid='".$getItemId."' data-cls-checkbox='mr-1 ml-1 mt-1 bg-darkCyan mb-1 p-1 border  bd-white rounded fg-white parameters-disabled parameters parameters-groupcommon  ".preg_replace("/^'|[^A-Za-z0-9\'-]|'$/", "-", strtolower(trim($options)))."' data-caption='".trim($options)."' data-cls-check='bd-white myCheck'>";
                                                            else:
                                                        ...
                                                        elseif(trim(strtolower($options)) == 'garments qty (size)'):
                                                            if(in_array(trim($options), $checkedOption)):
                                                                $cellData2 .= "<input type='checkbox' data-role='checkbox' value='".trim($options)."' data-parentid='".$getItemId."' data-cls-checkbox='mr-1 ml-1 mt-1 bg-darkCyan mb-1 p-1 border  bd-white rounded fg-white parameters-disabled parameters parameters-groupcommon  ".preg_replace("/^'|[^A-Za-z0-9\'-]|'$/", "-", strtolower(trim(str_replace('(', '', $options))))."' checked data-caption='".trim($options)."' data-cls-check='bd-white myCheck'>";
                                                            elseif(in_array('Color Wise Qty', $checkedOption) == false && in_array('Color & Size Wise Qty', $checkedOption) == false && in_array('Kimball/Color/Size Wise Qty', $checkedOption) == false && in_array('Size Wise Qty', $checkedOption) == false && in_array('Kimball & Color Wise Qty', $checkedOption) == false && in_array('Garments Qty', $checkedOption) == false):
                                                                $cellData2 .= "<input type='checkbox' data-role='checkbox' value='".trim($options)."' data-parentid='".$getItemId."' data-cls-checkbox='mr-1 ml-1 mt-1 bg-darkCyan mb-1 p-1 border  bd-white rounded fg-white parameters-disabled parameters parameters-groupcommon ".preg_replace("/^'|[^A-Za-z0-9\'-]|'$/", "-", strtolower(trim(str_replace('(', '', $options))))."' data-caption='".trim($options)."' data-cls-check='bd-white myCheck'>";
                                                            else:
                                                                $cellData2 .= "<input type='checkbox' data-role='checkbox' value='".trim($options)."' data-parentid='".$getItemId."' data-cls-checkbox='mr-1 ml-1 mt-1 bg-darkCyan mb-1 p-1 border  bd-white rounded fg-white parameters-disabled parameters parameters-groupcommon  ".preg_replace("/^'|[^A-Za-z0-9\'-]|'$/", "-", strtolower(trim(str_replace('(', '', $options))))."' disabled data-caption='".trim($options)."' data-cls-check='bd-white myCheck'>";
                                                            endif;
                                                        else:
                                                ...
                                                <tr>
                                                    ...
                                                    foreach ($checkedOption as $ckey => $columnCombine):
                                                        ...
                                                        ?>
                                                            ...
                                                            <th class='<?=$columntrid?>-header colorsizeqty-header' data-columnname=''><div>Size Wise Qty</div><?=$csize;?></th>
                                                        <?php
                                                        elseif($columnCombine == 'Garments Qty (Size)'):
                                                           $sizeName =  explode(',', $item['VSIZENAME']);
                                                            $csize = '<div class="row no-gap">';
                                                            foreach ($sizeName as $skey => $val):
                                                                $csize .= '<div class="cell size-'.$val.'-header bg-gray border bd-light csize-header" style="min-width: 60px;">'.$val.'</div>';
                                                ...
                                                ?>
                                                    ...
                                                    foreach ($checkedOption as $ckey => $columnCombine):
                                                        ...
                                                        elseif($columnCombine == 'Garments Qty (Size)'):
                                                            ...
                                                            $ksize = '<div class="row no-gap">';
                                                            $sizeConArr = explode(',', $allSize);
                                                            foreach ($sizeConArr as $sizeValue):
                                                                $ksize .= '<div class="cell size-'.preg_replace("/^'|[^A-Za-z0-9\'-]|'$/", "-", $sizeValue).' bg-gray border bd-light" style="min-width: 60px;"><input type="text" class="csize-input input-small text-center size-'.preg_replace("/^'|[^A-Za-z0-9\'-]|'$/", "-", $sizeValue).'-input colorsizewiseqtyinput" data-sizename="'.$sizeValue.'"  value="0" style="width: 100%;" ondblclick="inputEnable($(this));" oninput="numberValidate($(this), $(this).val()); manualGarmentsQty(\''.$parentId.'\', $(this));"><input type="hidden" class="csaddition-qty-hidden additionsize-'.preg_replace("/^'|[^A-Za-z0-9\'-]|'$/", "-", $sizeValue).'-input" value="0"></div>';
                                                            endforeach;
                                                            $ksize .= '</div>';
                                                            ?>
                                                            <td class='<?=$columntrid?> colorsizeqty'><?=$ksize?></td>
                                                        ...
                                                        elseif($columnCombine == 'Size Name'):
                                                            ...
                                                            ?>
                                                            <td class='<?=$columntrid?> size-celll-manual' style='position:relative;'><?=$sizeG?><div class='data-content' onclick="inputFieldAppend($(this), 'data-content')"></div><span class='tally picker-popup' onclick='colorPicker($(this), "<?=$parentId?>");'><span class='icon mif-yelp'></span></span></td>
                                                        <?php
                                                        elseif($columnCombine == 'Addition'):
                                                        ?>
                                                            <td class='<?=$columntrid?>' style='position:relative;'>
                                                        ...
                                                        ?>
                                                            <td class='<?=$columntrid?>' style='position:relative;'>
                                                                 <input type="text" class="data-copier input-small text-center row-convertion-input" name="convertioninput" oninput="numberValidate($(this), $(this).val()); convertionCalculate('<?=$parentId?>', $(this));" style="min-width: 80px; max-width:100%; margin: 0 auto;" value="1" <?=!empty($item['NCONVERSIONVALUE']) ? 'data-convertionval="'.$item['NCONVERSIONVALUE'].'"' : '';?>    <?=!empty($item['VCONVERTIOMNTYPE']) ? 'data-calinputtype="'.$item['VCONVERTIOMNTYPE'].'"' : '';?> >
                                                                <a class="tally copybtn" href="javascript:void(0)" style="position: absolute;top: 1px;right: 1px;" onclick="dataCopyWithCalculation($(this), '<?=$columntrid?>', '<?=$parentId?>');"><span class="mif-copy"></span></a>
                                                            </td>
                                                        <?php
                                                        elseif($columnCombine == 'Garments Qty'):
                                                ...
                                                ?>
                                                    ...
                                                    foreach ($checkedOption as $ckey => $columnCombine):
                                                        ...
                                                        elseif($columnCombine == 'Size Name'):
                                                            ...
                                                            $sizeG .= '</a></div></div></div></div>';
                                                            ?>
                                                            <td class='<?=$columntrid?> size-celll-manual' style='position:relative;'><?=$sizeG?><div class='data-content' onclick="inputFieldAppend($(this), 'data-content')"><?=$data['SIZENAME']?></div><span class='tally picker-popup' onclick='colorPicker($(this), "<?=$parentId?>");'><span class='icon mif-yelp'></span></span></td>
                                                        <?php
                                                        elseif($columnCombine == 'Addition'):
                                                        ?>
                                                            <td class='<?=$columntrid?>' style='position:relative;'>
            ...
            <?php
            elseif($_GET['page'] == 'copy'):
                $id = isset($_GET['to']) ? $_GET['to'] : 0;
                $orderNumberOrFklNumber = isset($_GET['from']) ? $_GET['from'] : 0;
                if($accessoriesModel->checkDataExistence("SELECT nid FROM accessories_workordermaster WHERE nid = $id AND nissuestatus = 1 AND ndeletedstatus = 0 AND napprovedstatus = 0 AND (vcreateduser = '$userid' OR vcreateduser IN ($managerFeature) OR (SELECT vrole FROM ACCESSORIES_USERSPERMISSION WHERE vfklid = '$userid') = 'admin' OR (SELECT vrole FROM ACCESSORIES_USERSPERMISSION WHERE vfklid = '$userid') = 'super admin')") == 'exist'):
                    $masterData = $accessoriesModel->getData("SELECT master.nid, master.vtodate, master.vponumber, master.vblockorderinfo, master.vstatus, master.vattn, master.vform, master.vordernumberorfklnumber, master.vtype, master.vorderdetails, master.vextranotes,  master.vgarmentsqty, master.vissue, master.nsupllierid FROM accessories_workordermaster master WHERE master.nid = $id AND master.nissuestatus = 1 AND master.ndeletedstatus = 0 AND master.napprovedstatus = 0 AND (master.vcreateduser = '$userid' OR master.vcreateduser IN ($managerFeature) OR (SELECT vrole FROM ACCESSORIES_USERSPERMISSION WHERE vfklid = '$userid') = 'admin' OR (SELECT vrole FROM ACCESSORIES_USERSPERMISSION WHERE vfklid = '$userid') = 'super admin') ORDER BY master.nid ASC");
                    if(strtolower($masterData[0]['VTYPE']) == 'order number'):
                        $orderNumber = $orderNumberOrFklNumber;
                        if(strtolower($masterData[0]['VORDERNUMBERORFKLNUMBER']) == 'block'):
                            $explodeBlockData = explode('##', $masterData[0]['VBLOCKORDERINFO']);
                            $orderInfo[0]['STYLENAME'] = isset($explodeBlockData[1]) ? $explodeBlockData[1] : '' ;
                            $orderInfo[0]['VSEASSONNAME'] = isset($explodeBlockData[3]) ? $explodeBlockData[3] : '' ;
                    ...
                    elseif(strtolower($masterData[0]['VTYPE']) == 'fkl number'):
                        $fklNumber = $orderNumberOrFklNumber;
                        if(strtolower($masterData[0]['VORDERNUMBERORFKLNUMBER']) == 'block'):
                            $explodeBlockData = explode('##', $masterData[0]['VBLOCKORDERINFO']);
                            $orderInfo[0]['STYLENAME'] = isset($explodeBlockData[1]) ? $explodeBlockData[1] : '' ;
                            $orderInfo[0]['VSEASSONNAME'] = isset($explodeBlockData[3]) ? $explodeBlockData[3] : '' ;
                    ...
                    <div data-role="panel" data-title-caption="Edit Work Order <strong>(W.O-<?=$masterData[0]['NID']?>)</strong>" data-title-icon="<span class='mif-pencil'></span>" class="workorder-form-panel" data-collapsible="false">
                        ...
                        <div class="p-1">
                            <form method="POST" action="" class="order-search">
                                            ...
                                            <div class="cell-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row" style="margin-left: 0px;margin-right: 0px;">
                                                        ...
                                                        <div class="cell-7" style="padding: 0px;">
                                                            <input type="text" data-role="input" class="input-small vordernumberorfklnumber" readonly data-cls-input="place-right" value="<?=$orderNumberOrFklNumber;?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                */
                                                ...
                                                <tr class="data-row-hidden appended-row" style="display: none;">
                                                    ...
                                                    foreach ($checkedOption as $ckey => $columnCombine):
                                                        ...
                                                        $columntrid = preg_replace('/-+/', '-', $columntrid);
                                                        if($columnCombine == 'Color Wise Qty'):
                                                            $colorWse = $workorderOpt->colorWiseData($fklNumber);
                                                            $presetData = $colorWse['color'];
                                                        ?>
                                                            <td class='<?=$columntrid?>' style='position:relative;'></td>
                                                            <td class='<?=$columntrid?>-qty'>
                                                                <input type='hidden' class='addition-qty-hidden' value='0'>
                                                        ...
                                                        <?php
                                                        elseif($columnCombine == 'Size Wise Qty'):
                                                            $sizeWiseQtyMain = $workorderOpt->sizeWiseQty($fklNumber);
                                                            $presetData =  $sizeWiseQtyMain['sizeQty'];
                                                        ?>
                                                            <td class='<?=$columntrid?>'></td>
                                                            <td class='<?=$columntrid?>-qty'>
                                                                <input type='hidden' class='addition-qty-hidden' value='0'>
                                                        ...
                                                        <?php
                                                        elseif($columnCombine == 'Color & Size Wise Qty'):
                                                            $colorNSizeWise = $workorderOpt->colorAndSizeWiseData($fklNumber);
                                                            $presetData = $colorNSizeWise['colorsizeQty'];
                                                        ?>
                                                            <td class='<?=$columntrid?>'></td><td class='<?=$columntrid?>'></td>
                                                        <?php
                                                        elseif($columnCombine == 'Kimball/Color/Size Wise Qty'):
                                                            $kimbalNColorNSizeWise = $workorderOpt->kimballColorSizeWiseData($fklNumber);
                                                            $presetData = $kimbalNColorNSizeWise['colorsizeQty'];
                                                        ?>
                                                            <td class='<?=$columntrid?>'></td>
                                                            <td class='<?=$columntrid?> kimballcelll'></td>
                                                            <td class='<?=$columntrid?>'></td>
                                                        ...
                                                        <?php
                                                        elseif($columnCombine == 'Kimball & Color Wise Qty'):
                                                            $kimbalNColorWise = $workorderOpt->kimballColorWiseData($fklNumber);
                                                            $presetData = $kimbalNColorWise['color'];
                                                        ?>
                                                            <td class='<?=$columntrid?>'></td>
                                                            <td class='<?=$columntrid?> kimballcelll'></td>
                                                            <td class='<?=$columntrid?>'></td>
                                                ...
                                                <?php
                                                $manualIndex = 0;
                                                $gartmentsGrandTotal = array();
                                                $extraGrandTotal = array();
                                                $grandTotal = array();
                                                foreach ($presetData as $dkey => $data):
                                                    $rowTotal = array();
                                                    $garmentsRowTotal = array();
                                                    $extraGarmentsRowTotal = array();
                                                    $addition = 0;
                                                    $strRowTotal = 0;
                                                    $strRowGarmentsTotal = 0;
                                                    $indexCount = $index++;
                                                    $indexMaker = $manualIndex++;
                                                    $sizeData = array();
                                                    if($indexMaker == 0):
                                                ?>
                                                    <tr class="data-row">
                                                        <td class='text-center text-bold maingrid-rowspan items-name items-<?=$getItemId?>' data-itemid='<?=$getItemId?>' rowspan='<?=count($presetData)?>'>
                                                            <?=$getItemName?>
                                                        </td>
                                                    <?php
                                                        foreach ($checkedOption as $ckey => $columnCombine):
                                                            ...
                                                            elseif($columnCombine == 'Color Wise Qty'):
                                                                ...
                                                                if(in_array('Addition', $checkedOption)):
                                                                    $addition = $workorderOpt->additionQty($colorWse['qty'][$indexMaker], $item['VADDITIONTYPE'], $item['NADDITIONVALUE']);
                                                                endif;
                                                                
                                                                $strRowTotal = $colorWse['qty'][$indexMaker];
                                                                $strRowGarmentsTotal = $colorWse['qty'][$indexMaker];
                                                                array_push($gartmentsGrandTotal, $strRowGarmentsTotal);
                                                            ?>
                                                                <td class='<?=$columntrid?> color-celll-fixed'><?=$data?></td>
                                                                <td class='<?=$columntrid?>-qty'>
                                                                    <input type='hidden' class='addition-qty-hidden' value='<?=$colorWse['qty'][$indexMaker]?>'>
                                                                    <input type='text' class='input-small text-center garments-qty-input' ondblclick='inputEnable($(this));' oninput='numberValidate($(this), $(this).val()); manualGarmentsQty("<?=$parentId;?>", $(this));' name='garmentsqty' readonly style='max-width:120px; margin: 0 auto;' value='<?=$colorWse['qty'][$indexMaker]?>'>
                                                                </td>
                                                            <?php
                                                            elseif($columnCombine == 'Size Wise Qty'):
                                                                if(in_array('Addition', $checkedOption)):
                                                                    $addition = $workorderOpt->additionQty($data, $item['VADDITIONTYPE'], $item['NADDITIONVALUE']);
                                                                endif;
                                                                
                                                                $strRowTotal = $data;
                                                                $strRowGarmentsTotal = $data;
                                                                array_push($gartmentsGrandTotal, $strRowGarmentsTotal);
                                                            ?>
                                                                <td class='<?=$columntrid?> size-celll-fixed'><?=$dkey?></td>
                                                                <td class='<?=$columntrid?>-qty'>
                                                                    <input type='hidden' class='addition-qty-hidden' value='<?=$data?>'>
                                                                    <input type='text' class='input-small text-center garments-qty-input' ondblclick='inputEnable($(this));' oninput='numberValidate($(this), $(this).val()); manualGarmentsQty("<?=$parentId;?>", $(this));' name='garmentsqty' readonly style='max-width:120px; margin: 0 auto;' value='<?=$data?>'>
                                                                </td>
                                                               
                                                            <?php
                                                            elseif($columnCombine == 'Color & Size Wise Qty'):
                                                            ?>
                                                                <td class='<?=$columntrid?> color-celll-fixed'><?=$dkey?></td>
                                                                <?php
                                                                $csize = '<div class="row no-gap">';
                                                                
                                                                foreach ($data as $skey => $sizeval):
                                                                    if(in_array('Addition', $checkedOption)):
                                                                        $sizeQtyCal = $workorderOpt->additionQty($sizeval, $item['VADDITIONTYPE'], $item['NADDITIONVALUE']);
                                                                    else:
                                                                        $sizeQtyCal = $sizeval;
                                                                    endif;
                                                                    array_push($extraGarmentsRowTotal, $sizeQtyCal);
                                                                    array_push($rowTotal, $sizeQtyCal);
                                                                    array_push($garmentsRowTotal, $sizeval);
                                                                    $csize .= '<div class="cell size-'.$skey.' bg-gray border bd-light" style="min-width: 60px;"><input type="text" class="csize-input input-small text-center size-'.$skey.'-input colorsizewiseqtyinput" data-sizename="'.$skey.'" readonly value="'.$sizeQtyCal.'" style="width: 100%;" ondblclick="inputEnable($(this));" oninput="numberValidate($(this), $(this).val()); manualGarmentsQty(\''.$parentId.'\', $(this));"><input type="hidden" class="csaddition-qty-hidden additionsize-'.$skey.'-input" value="'.$sizeval.'"></div>';
                                                                endforeach;
                                                                $addition = array_sum($extraGarmentsRowTotal);
                                                                $strRowTotal = array_sum($rowTotal);
                                                                $strRowGarmentsTotal = array_sum($garmentsRowTotal);
                                                                array_push($gartmentsGrandTotal, $strRowGarmentsTotal);
                                                            ...
                                                            elseif($columnCombine == 'Kimball/Color/Size Wise Qty'):
                                                            ?>
                                                                <td class='<?=$columntrid?> color-celll-fixed'><?=str_replace("*lot*".$kimbalNColorNSizeWise['lot'][$indexMaker], "", $dkey)?></td>
                                                                <td class='<?=$columntrid?> kimball-cell kimballcelll'><?=$kimbalNColorNSizeWise['kimball'][$indexMaker]?></td>
                                                                <td class='<?=$columntrid?> lot-cell'><?=$kimbalNColorNSizeWise['lot'][$indexMaker]?></td>
                                                                <?php
                                                                $csize = '<div class="row no-gap">';
                                                                // $sizeName =  explode(',', $item['VSIZENAME']);
                                                                foreach ($data as $skey => $sizeval):
                                                                        ...
                                                                        array_push($rowTotal, $sizeQtyCal);
                                                                        array_push($garmentsRowTotal, $sizeval);
                                                                    $csize .= '<div class="cell size-'.$skey.' bg-gray border bd-light" style="min-width: 60px;"><input type="text" class="csize-input input-small text-center size-'.$skey.'-input colorsizewiseqtyinput" data-sizename="'.$skey.'" ondblclick="inputEnable($(this));" oninput="numberValidate($(this), $(this).val()); manualGarmentsQty(\''.$parentId.'\', $(this));" readonly value="'.$sizeQtyCal.'" style="width: 100%;"><input type="hidden" class="csaddition-qty-hidden additionsize-'.$skey.'-input" value="'.$sizeval.'"></div>';
                                                                endforeach;
                                                                $csize .= '</div>';
                                                                $addition = array_sum($extraGarmentsRowTotal);
                                                                $strRowTotal = array_sum($rowTotal);
                                                            ...
                                                            elseif($columnCombine == 'Kimball & Color Wise Qty'):
                                                                if(in_array('Addition', $checkedOption)):
                                                                    $addition = $workorderOpt->additionQty($kimbalNColorWise['qty'][$indexMaker], $item['VADDITIONTYPE'], $item['NADDITIONVALUE']);
                                                                endif;
                                                                
                                                                $strRowTotal = $kimbalNColorWise['qty'][$indexMaker];
                                                                $strRowGarmentsTotal = $kimbalNColorWise['qty'][$indexMaker];
                                                                array_push($gartmentsGrandTotal, $strRowGarmentsTotal);
                                                            ?>
                                                                <td class='<?=$columntrid?> color-celll-fixed'><?=$data?></td>
                                                                <td class='<?=$columntrid?> kimballcelll kimball-cell text-center'><?=$kimbalNColorWise['kimball'][$indexMaker]?></td>
                                                                <td class='<?=$columntrid?> lot-cell text-center'><?=$kimbalNColorWise['lot'][$indexMaker]?></td>
                                                                <td class='<?=$columntrid?>-qty'>
                                                                    <input type='hidden' class='addition-qty-hidden' value='<?=$kimbalNColorWise["qty"][$indexMaker]?>'>
                                                                    <input type='text' class='input-small text-center garments-qty-input' ondblclick='inputEnable($(this));' oninput='numberValidate($(this), $(this).val()); manualGarmentsQty("<?=$parentId;?>", $(this));' name='garmentsqty' readonly style='max-width:120px; margin: 0 auto;' value='<?=$kimbalNColorWise["qty"][$indexMaker]?>'>
                                                                </td>
                                                         
                                                            <?php
                                                            elseif($columnCombine == 'Addition'):

                                                                 array_push($extraGrandTotal, $addition);
                                                            ?>
                                                                <td class='<?=$columntrid?>' style='position:relative;'>
                                                                    <input type="text" readonly="" class="input-small text-center row-garmentsqtyextra-input" name="garmentsextraqty" ondblclick="inputEnable($(this));" oninput="numberValidate($(this), $(this).val()); manualExtraGarmentsQty('<?=$parentId?>', $(this));" style="min-width: 80px; max-width:100%; margin: 0 auto;" value="<?=$addition?>" data-additionval="<?=$item['NADDITIONVALUE']?>" data-additiontype="<?=$item['VADDITIONTYPE']?>">
                                                                </td>
                                                            <?php
                                                            elseif($columnCombine == 'Converter'):
                                                            ?>
                                                                <td class='<?=$columntrid?>' style='position:relative;'>
                                                                    <input type="text" class="data-copier input-small text-center row-convertion-input" name="convertioninput" oninput="numberValidate($(this), $(this).val()); convertionCalculate('<?=$parentId?>', $(this));" style="min-width: 80px; max-width:100%; margin: 0 auto;" value="<?=isset($gridData[$indexMaker]['NCONVERTERQTY']) ? $gridData[$indexMaker]['NCONVERTERQTY'] : 0; ?>" <?=!empty($item['NCONVERSIONVALUE']) ? 'data-convertionval="'.$item['NCONVERSIONVALUE'].'"' : '';?>  <?=!empty($item['VCONVERTIOMNTYPE']) ? 'data-calinputtype="'.$item['VCONVERTIOMNTYPE'].'"' : '';?>>
                                                                    <a class="tally copybtn" href="javascript:void(0)" style="position: absolute;top: 1px;right: 1px;" onclick="dataCopyWithCalculation($(this), '<?=$columntrid?>', '<?=$parentId?>');"><span class="mif-copy"></span></a>
                                                                </td>
                                                            <?php
                                                            elseif($columnCombine == 'PN No.'): ?>
                                                                <td class="pn-no-cell <?=$columntrid?> text-center" rowspan="<?=count($presetData);?>"><input type="text" class="input-small pn-no-input text-center" name="pnnumber" style="max-width:120px; margin: 0 auto;" value="<?=$item['VPNNUMBER']?>"></td>
                                                            <?php
                                                            elseif($columnCombine == 'Order No.'):
                                                            ?>
                                                            <td class="order-no-cell <?=$columntrid?>" rowspan="<?=count($presetData);?>"><input type="text" class="input-small order-no-input" name="ordernumber" style="max-width:120px; margin: 0 auto;" value="<?=$item['VORDERNUMBER']?>"></td>                                                                    
                                                            <?php       
                                                            elseif($columnCombine == 'Code No.'):
                                                            ?>
                                                                <td class='<?=$columntrid?>'>
                                                                    <textarea class='code-no-input custom-column-value data-copier' name='codenumber' style='max-width:100%; margin: 0 auto; height: 40px;'><?=isset($gridData[$indexMaker]["CODENO"]) ? $gridData[$indexMaker]["CODENO"] : '';?></textarea>
                                                                </td>
                                                            <?php
                                                            else:
                                                                if($columnCombine != 'Symbol'):
                                                            ...
                                                            ?>
                                                                    <td class='<?=$columntrid?>' style="position: relative;">
                                                                        <textarea class="custom-column-value data-copier" style="max-width:100%; margin: 0 auto; height: 40px;"><?=isset($gridData[$indexMaker]["$columnname"]) ? $gridData[$indexMaker]["$columnname"] : '';?></textarea><a class="tally copybtn" href="javascript:void(0)" style="position: absolute;top: 1px;right: 1px;" onclick="dataCopy($(this), '<?=$columntrid?>', '<?=$parentId?>');"><span class="mif-copy"></span></a>
                                                                    </td>
                                                        <?php
                                                                endif;
                                                            endif;
                                                    ...
                                                    ?>
                                                         <td class='totalqty'>
                                                            <?php 
                                                            if(in_array('Converter', $checkedOption) && in_array('Addition', $checkedOption)):
                                                                $woRequired = $workorderOpt->conversionCalculate($addition, $item['VCONVERTIOMNTYPE'], isset($gridData[$indexMaker]['NCONVERTERQTY']) ? $gridData[$indexMaker]['NCONVERTERQTY'] : 0, !empty($item['NCONVERSIONVALUE']) ? $item['NCONVERSIONVALUE'] : '', $item['VQTYUNIT']);
                                                            elseif(in_array('Converter', $checkedOption) && !in_array('Addition', $checkedOption)):
                                                                    $woRequired = $workorderOpt->conversionCalculate($strRowTotal, $item['VCONVERTIOMNTYPE'], isset($gridData[$indexMaker]['NCONVERTERQTY']) ? $gridData[$indexMaker]['NCONVERTERQTY'] : 0, !empty($item['NCONVERSIONVALUE']) ? $item['NCONVERSIONVALUE'] : '', $item['VQTYUNIT']);
                                                            else:
                                                                if(in_array('Addition', $checkedOption)):
                                                                    $woRequired = $addition;
                                                                else:
                                                                    $woRequired = $strRowTotal;
                                                                endif;

                                                            endif;
                                                            array_push($grandTotal, $woRequired);

                                                            ?>
                                                                <div class='row no-gap'>
                                                                    <div class='cell'>
                                                                        <input type='text' readonly class='input-small text-center row-totalqty-input' ondblclick='inputEnable($(this));' oninput='numberValidate($(this), $(this).val()); rowSum("<?=$parentId;?>")' name='rowtotalqty' style='min-width: 80px; max-width:100%; margin: 0 auto;' value='<?=$woRequired?>'>
                                                                    </div>
                                                                    <div class='cell text-center bg-light' style='width:10px; line-height:25px; overflow:hidden;'><span class='text-bold'><?=$item['VQTYUNIT']?></span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td class='remarks' style='position:relative;'>
                                                                <textarea style='max-width: 100%; height:40px; margin: 0 auto;' class='remarks-input data-copier' name='vremarks'><?=isset($gridData[$indexMaker]['VREMARKS']) ? $gridData[$indexMaker]['VREMARKS'] : ''; ?></textarea>
                                                                <a class='tally copybtn' href='javascript:void(0)' style='position: absolute;top: 1px;right: 1px;' onclick='dataCopy($(this), "remarks", "<?=$parentId;?>")'><span class='mif-copy'></span>
                                                                </a>
                                                            </td>
                                                            <?php
                                                            if(in_array('Symbol', $checkedOption)):
                                                                ...
                                                                $columntrid = preg_replace('/-+/', '-', $columntrid);
                                                            ?>
                                                                <td class="symbol-cell <?=$columntrid?> text-center" rowspan="<?=count($presetData);?>">
                                                                    <div class="<?=$parentId?>-symbol">
                                                                        <input type='file' name='attachment[]' multiple data-role='file' data-mode='drop' onchange='checkimage($(this), 4); checkvalidformat($(this));' class='symbol-input'><small>Allowed file format: jpg/png/jpeg/gif, Max allowed : 4 images.</small>
                                                                    </div>
                                                ...
                                                <tr style="background: #e0f0f1;">
                                                    ...
                                                    <?php
                                                        foreach ($checkedOption as $ckey => $columnCombine):
                                                            ...
                                                            ?>
                                                                <td class='<?=$columntrid?>'></td>
                                                                <td class='<?=$columntrid?>-qty'>
                                                                    <input type="text" class="input-small text-center garmentsgrandtotal" name="garmentsgrandtotal" style="min-width: 80px; max-width:120px; margin: 0 auto;" value="<?=array_sum($gartmentsGrandTotal)?>" readonly="">
                                                                </td>
                                                            <?php
                                                            elseif($columnCombine == 'Color & Size Wise Qty'):
                                                            ?>
                                                                <td class='<?=$columntrid?>'></td>
                                                                <td class='<?=$columntrid?>' style='position:relative;'>
                                                                <input type='hidden' class='input-small text-center garmentsgrandtotal' name='garmentsgrandtotal' style='min-width: 80px; max-width:120px; margin: 0 auto;' value='<?=array_sum($gartmentsGrandTotal)?>'>
                                                            </td>
                                                            ...
                                                            ?>
                                                                <td class='<?=$columntrid?>' style='position:relative;'>
                                                                    <input type='text' class='input-small text-center garmentsextragrandtotal' name='garmentsextragrandtotal' style='min-width: 80px; max-width:100%; margin: 0 auto;' value='<?=array_sum($extraGrandTotal)?>' readonly>
                                                                </td>
                                                    ...
                                                    ?>
                                                        <td class="grandtotalqty">
                                                            <div class="row no-gap">
                                                                <div class="cell">
                                                                    <input type="text" readonly="" class="input-small text-center grand-totalqty-input" name="grandqty" style="min-width: 80px; max-width:100%; margin: 0 auto;" value="<?=array_sum($grandTotal);?>">
                                                                </div>
                                                                <div class="cell text-center bg-light" style="width:10px; line-height:25px; overflow:hidden;">
                                                                    <span class="text-bold grandunit"><?=$item['VQTYUNIT']?></span>
                                                                </div>
                                ...
                                <div class="row submit-section text-center d-flex flex-justify-center">
                                    <button type="button" name="workorder-submit" data-type="publish" class="workorder-submit image-button border bd-dark-hover success mr-2">
                                    <span class='mif-plus icon'></span>
                                    <span class="caption text-bold">Publish Work Order</span>
                                    </button>
                                    <button type="button" data-type="draft" class="image-button workorder-submit success bg-orange bg-darkOrange-hover ml-2-md border bd-dark-hover mr-2">
                                    <span class='mif-spinner icon'></span>
                                    <span class="caption text-bold" >Publish Later (Draft)</span>
                                    </button>

                                    <a  href="workorder.php?page=copy&to=<?=$id?>&from=<?=$orderNumberOrFklNumber?>" class="image-button warning ml-2-md border bd-dark-hover">
                                    <span class='mif-refresh icon'></span>
                                    <span class="caption text-bold" >Refresh</span>
                                    </a>
                                </div>
