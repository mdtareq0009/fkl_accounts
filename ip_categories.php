...
?>
                ...
                <div class="content-wrapper" id="categories">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <ol class="breadcrumb float-sm-left">
                                        ...
                                        <li class="breadcrumb-item active" style="color: #ffdc2f;">IP Category</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="content">
                        <div class="container-fluid">
                            ...
                            if ($_GET['page'] == 'all-ip-categories'):

                                if ($auth->verifyUserPermission('checked', 'ip_cat_create') 
                            ...
                            ?>
                                        ...
                                        <div class="col-md-12 col-lg-4 offset-lg-4">
                                            <div class="card card-secondary pt-2">
                                                <div class="card-header p-2">
                                                    <h3 class="card-title">IP Category Entry</h3>
                                                </div>
                                                <form id="ipcategoryForm">
                                                    <div class="card-body p-2" id="category">
                                                        <div class="form-group">
                                                            <label for="vname">IP Category Name</label>
                                                            <input type="text" id="csrf" hidden  value="<?= $db->csrfToken() ?>" name="csrf" />
                                                            <input type="text" id="nid" hidden class="nid" name="N_ID" />
                                                            <input type="text" id="vname" class="form-control form-control-sm form-control-border vname" name="V_NAME" placeholder="Enter Category Name" />
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="card">
                                                <div class="card-header p-2">
                                                    <h3 class="card-title">IP Category List</h3>
                                                </div>
                                                <!-- /.card-header -->
                                                    ...
                                                    <table id="example2" class="table table-bordered table-striped example1">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <?php if (($auth->verifyUserPermission('checked', 'ip_cat_edit') == true) || ($auth->verifyUserPermission('checked', 'ip_cat_del') == true) || $auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin')) { ?>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $(document).on('click', '.deleteId', function() {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    let quaryType = 'delete-ip-categories';
                                    let fd = new FormData();
                        ...
                        $('#ipcategoryForm').on('submit', function(e) {
                            e.preventDefault(); 
                           let  types = {
                                 V_NAME : $('#vname').val(),
                                 N_ID : $('#nid').val(),
                                ...
                                res.forEach((row, sl) => {
                                    const row1 = `<tr data-id="${row.N_ID}">
                                            ...
                                            <td>${row.UPDATEDUSER?row.UPDATEDUSER:'N/A'}</td>
                                             <td align="center">
                                             <?php if ($auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin') || ($auth->verifyUserPermission('checked', 'ip_cat_edit') == true)) { ?>
                                                ...
                                                <?php  } ?>
                                                <?php if ($auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin') || ($auth->verifyUserPermission('checked', 'ip_cat_del') == true)) { ?>
                    ...
                    function editType(data) {
                        ...
                        $('#category .vname').val(rowData.V_NAME); 
                        $('#category .nid').val(rowData.N_ID);     
                    }
