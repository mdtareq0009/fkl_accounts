            ...
            <div class="content-inner h-100" style="overflow-y: auto">
                                            ...
                                            <!-- <tr>
                                                ...
                                                <td style="padding: 1px 4px;">
                                                    <table>
                                                        <tr>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Gate pass" value="1">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Received" value="2">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Inventory" value="3">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Department Head" value="4">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Approve" value="5">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Create" value="6">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="View" value="7">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Scurity Pass" value="8">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Basic Entry" value="9">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Godown" value="10">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Item" value="11">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Supplier" value="12">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Party" value="13">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Gatepass Check" value="14">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Report" value="15">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Merchandising Report" value="16">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Audit" value="17">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Tally Security" value="18">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Delete" value="19">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VGATEPASS[]" data-style="2" data-caption="Create Driver" value="20">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td style="padding: 1px 4px;">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VAPPROVEDWORORDER[]" data-style="2" data-caption="Accept" value="8">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                            ...
                                                            <!-- <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VCHECKED[]" data-style="2" data-caption="Cost Sheet" value="8">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VCHECKED[]" data-style="2" data-caption="Cost Sheet Settings" value="9">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VCHECKED[]" data-style="2" data-caption="Accept" value="10">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VCHECKED[]" data-style="2" data-caption="Approve" value="11">
                                                            </td> -->
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 1px 4px;">
                                                    <table>
                                                        <tr>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VCOSTSHEET[]" data-style="2" data-caption="Cost Sheet" value="1">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VCOSTSHEET[]" data-style="2" data-caption="Cost Sheet Settings" value="2">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VCOSTSHEET[]" data-style="2" data-caption="Accept" value="3">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" type="checkbox" data-role="checkbox" name="VCOSTSHEET[]" data-style="2" data-caption="Approve" value="4">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                ...
                elseif($_GET['page'] == 'edit'):
                    ...
                    if($accessoriesModel->checkDataExistence("SELECT nid FROM ACCESSORIES_USERSPERMISSION WHERE nid = $id") == 'exist'):
                        ...
                        vpurchasecodeprefix, vrole, vdraftworkorder, vpublishedworkorder, vapprovedwororder, vacceptedworkorder, vallworkorder, vdashboard, vsuppliers, vgroups, vsubgroups, vmou, vgoodsoptions, vgoods, vuserpermission, vtrash, vchecked,vgatepass,vcostsheet FROM ACCESSORIES_USERSPERMISSION 
                        LEFT JOIN hrm_employee users ON users.VEMPLOYEEID = vfklid 
                        LEFT JOIN hrm_employee manager ON manager.VEMPLOYEEID = vmanagerid 
                        LEFT JOIN hrm_employee subordinate ON subordinate.VEMPLOYEEID = vsubordinateid 
                        LEFT JOIN hrm_employee subordinate_2 ON subordinate_2.VEMPLOYEEID = vsubordinate_2 
                        WHERE nid = $id");
                        ...
                        $gatepassPermission     = explode(',', $paermissionData[0]['VGATEPASS']);
                                                ...
                                                <td style="padding: 1px 4px;">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td style="padding: 1px 4px;">
                                                                <input class="permission-checkbox-common super-adminpermission" <?=(in_array(8, $approvedWoPermission) ? 'checked' : '' )?> type="checkbox" data-role="checkbox" name="VAPPROVEDWORORDER[]" data-style="2" data-caption="Accept" value="8">
                                                            </td>
                                                            <td style="padding: 1px 4px;">
