                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <ol class="breadcrumb float-sm-left">
                                        ...
                                        <li class="breadcrumb-item active" style="color: #ffdc2f;">IP Type</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                            ...
                            ?>
                                        ...
                                        <div class="col-md-12 col-lg-4 offset-lg-4">
                                            <div class="card card-secondary pt-2">
                                                <div class="card-header p-2">
                                                    <h3 class="card-title">IP Type Entry</h3>
                                                </div>
                                                <form id="ipcategoryForm">
                                                    <div class="card-body p-2" id="category">
                                                        <div class="form-group">
                                                            <label for="vname">IP Type Name</label>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="card">
                                                <div class="card-header p-2">
                                                    <h3 class="card-title">IP Type List</h3>
                                                </div>
                                                <!-- /.card-header -->
                                                    ...
                                                    <table id="example2" class="table table-bordered table-striped example1">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <?php if (($auth->verifyUserPermission('checked', 'cat_edit') == true) || ($auth->verifyUserPermission('checked', 'cat_del') == true)) { ?>
                                                                    <th>Action</th>
                                                                <?php } ?>
                        ...
                        $('#ipcategoryForm').on('submit', function(e) {
                           ...
                           let  types = {
                            ...
                            if (types.V_NAME == '' || types.V_NAME == null) {
                                Toast.fire({
                                            icon: 'info',
                                            title: 'Please Enter a IP Type name'
                                })
                                return;
                            }

                            let quaryType = 'add-ip-types';

                            if (types.N_ID != '') {
                                quaryType = 'edit-ip-types';
                            }
