                    ...
                    <div class="content-inner h-100" style="overflow-y: auto">
                        <div class="row-fluid">
                            <div class="cell-md-12">
                                <div data-role="panel" data-title-caption="Final Approve Work Order" data-collapsible="false" data-title-icon="<span class='mif-done_all'></span>">
                                    <div class="ml-1 mr-1">
                                        <table
                                            ...
                                            data-cls-table-container="approve-workorder-table"
                                            data-source="data/approve-workorder-new.php"
                                            data-horizontal-scroll="true"
                                            data-table-info-title="Showing from $1 to $2 of $3 Approve Work Order(s)"
