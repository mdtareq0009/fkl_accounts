        ...
        <div class="navview-content h-100">
            ...
            <div class="content-inner h-100" style="overflow-y: auto">
                ...
                <div class="cell-md-12">
                    <div data-role="panel" data-title-caption="Create Top Sheet" data-collapsible="false" data-title-icon="<span class='mif-done_all'></span>">
        <div class="ml-1 mr-1">
        <div class="row">
            ...
            <table 
                class="table striped table-border cell-border subcompact mt-1 accessories-table-common topsheet-workorder-table"
                id="topsheet-workorder-table"
                data-role="table"
                ...
                data-cls-table-container="topsheet-workorder-table"
                data-source="data/topsheet-data.php"
                ...
                <tr>
                    ...
                    <td style="padding: 1px;"><button class="image-button success" type="button" onclick="workorderViewOperation('topsheet-workorder-table', 'topsheet', 'topsheet_create.php');" style="height: 22px; padding: 0 2px 0 0;"><span class="mif-done_all icon" style="height: 22px; line-height: 22px; font-size: .9rem; width: 20px;"></span><span class="caption" style="margin-left: 2px;">Topsheet</span></button></td>
