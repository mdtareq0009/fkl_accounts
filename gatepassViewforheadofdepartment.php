                    ...
                    <!-- <div class="container" id="print-js"> -->
                        ...
                        <!-- <table class="table row-border cell-border border row-hover cell-hover subcompact" data-rownum="true" data-role="table"> -->
                            ...
                            <?php
                                    ...
                                    where HEAD_OF_DEPARTMENT_STATUS=1 and (m.DELETE_STATUS=0 or m.delete_status=null) and (created_by = '$userId'
                            ...
                            ?>
                                <tr class="text-center data-font">
                                    ...
                                    <?php if ($row['APPROVED_STATUS'] == 0 or $row['APPROVED_STATUS']== null ){ ?>
                                        <a onclick="approvedData(this.id)" class="button small warning fg-white rounded mif-done" id="<?php echo $row['ID'] ?>" title="Click to approve by head of department"></a> 
                                        <?php }else{ ?>
