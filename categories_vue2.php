...
?>
        ...
        <body class="m4-cloak h-vh-100">
            ...
            <div data-role="navview" data-toggle="#paneToggle" data-expand="xxl" data-compact="xl" data-active-state="true">
                ...
                ================================================*/
                        if ($_GET['page'] == 'all-categories'):
                            if ($auth->verifyUserPermission('checked', 'cat_create')):
                        ?>
                                    ...
                                    <div class="row-fluid">
                                        <div class="d-flex flex-justify-center">
                                            <div class="cell-lg-12">
                                                <div data-role="panel" data-title-caption="Add Category" data-title-icon="<span class='mif-plus'></span>" class="groups-form-panel" data-collapsible="false">
                                                    <div class="p-1">
                                                                ...
                                                                <div class="row">
                                                                    <div class="cell-sm-12">
                                                                        <div class="form-group">
                                                                            <label>Category Name<span class="fg-red">*</span></label>
                                                                            <input type="text" class="input-small required-field" @input="getData()" v-model="type.VNAME" placeholder="Enter Category Name">
                                                                            <span class="btn-master btn-delete" style="top: 8px;position: relative;" v-if="show">Category name is required.</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="cell-12 d-flex flex-justify-end mt-2">
                                                                        <button type="submit" name="group-submit" v-bind:disabled="progress ? true : false" class="image-button border bd-dark-hover success mr-2">
                                                                            ...
                                                                            <span class="caption text-bold">{{type.NID =='' ? 'Save' : 'Update'}}</span>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="cell-md-12">
                                                <div data-role="panel" data-title-caption="All Category" data-collapsible="false" data-title-icon="<span class='mif-stack'></span>">
                                                    <div class="ml-1 mr-1">
                                                        ...
                                                        <tr v-for="(row,sl) in paginatedData" :key="sl">
                                                            ...
                                                            <?php if (($auth->verifyUserPermission('checked', 'cat_edit') == true) || ($auth->verifyUserPermission('checked', 'cat_del') == true)) { ?>
                                                                <td width="11%" align="center">
                                                                    <?php if ($auth->verifyUserPermission('checked', 'cat_edit') == true) { ?>
                                                                        <a class="blue btn-master btn-edit" href="javascript:" @click="editType(row)">
                                                                            <span class="mif-history"></span> Edit
                                                                        </a>
                                                                    <?php } ?>
                                                                    <?php if ($auth->verifyUserPermission('checked', 'cat_del') == true) { ?>
                ...
                new Vue({
                    ...
                    /// for End Pagination 
                        ...
                        save() {
                            ...
                            if(this.type.VNAME == '' || this.type.VNAME == null){
                                this.show = true;
                                setTimeout(()=>{
                                    this.show = false;
                                },2000);
                        ...
                        deleteType(data){
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        let quaryType = 'delete-categories';
                                        let fd = new FormData();
                                        fd.append('data', data);
                                        fd.append('formName', quaryType);
