    ...
    <div data-role="navview" data-toggle="#paneToggle" data-expand="xxl" data-compact="xl" data-active-state="true">
        ...
        <div class="input-small navview-content h-100">
            ...
            <div class="input-small content-inner h-100" style="overflow-y: auto">
                ...
                <h4 class="dashboard-section-title text-center text-left-md w-100 content-title-big" data-group="setting" data-page="<?php //echo $pageOpt->currentPageClass()?>" style="font-size: 1.2rem; line-height: 1; font-weight: bold; text-shadow: 1px 1px 2px #fff;"><span class="icon"><span class="mif-pencil"></span></span> Revise Cost Sheet</h4>
<!-- ================================Content======================================================== -->
                <!-- <form action="javascript:void()" method="post" id="form" onsubmit="return checkForm(this);"> -->
                <form action="costsheetSubmit.php?pageType=revise" method="post" id="form" name="form"  enctype="multipart/form-data" onsubmit="return checkForm(this);">
                <?php
...
<br><hr>
        <div class="form-group text-center ">
            ...
            <!-- <button type="submit" name="updateButton" id="myButton" class="button success rounded mb-4 mt-4 mr-5" value="1">Publish</button> -->
            <button type="submit" name="reviseButton" id="" class="button info rounded mb-4 mt-4" value="<?php $revise = $accessoriesModel->reviseLastRow('INV.MRD_PRECOSTING_MASTER','REVISE_STATUS','where mpm_no='.$masterId); echo $revise;?>">Revise</button>
            <!-- <button type="submit" name="reviseButton" id="" class="button info rounded mb-4 mt-4" value="<?php //$revise = $accessoriesModel->lastRow('INV.MRD_PRECOSTING_MASTER','REVISE_STATUS'); echo $revise;?>">Revise</button> -->
