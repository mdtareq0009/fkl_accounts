                    ...
                    <div class="content-inner h-100" style="overflow-y: auto">
                        <div class="row-fluid">
                            <div class="cell-md-12">
                                <div data-role="panel" data-title-caption="Proceed for Audit" data-collapsible="false" data-title-icon="<span class='mif-done_all'></span>">
                                    <div class="ml-1 mr-1">
                                        <table
                                            class="table striped table-border cell-border subcompact mt-1 accessories-table-common audit-table"
                                            data-role="table"
                                            ...
                                            data-cls-table-container="audit-table"
                                            data-source="data/audit-data.php"
                                            data-horizontal-scroll="true"
                                            data-table-info-title="Showing from $1 to $2 of $3 Audit Work Order(s)"
                                            ...
                                            ?>
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td style="padding: 1px;"><button class="image-button success" type="button" onclick="workorderViewOperation('audit-table', 'audit', 'audit.php');" style="height: 22px; padding: 0 2px 0 0;"><span class="mif-done_all icon" style="height: 22px; line-height: 22px; font-size: .9rem; width: 20px;"></span><span class="caption" style="margin-left: 2px;">Audit</span></button></td>
