                ...
                <div class="content-wrapper" id="categories">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <ol class="breadcrumb float-sm-left">
                                        ...
                                        <li class="breadcrumb-item active" style="color: #ffdc2f;">Brand</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="content">
                        <div class="container-fluid">
                            ...
                            if ($_GET['page'] == 'all-brands'):

                                if ($auth->verifyUserPermission('checked', 'brand_create') 
                                                ...
                                                <form id="categoryForm">
                                                    <div class="card-body p-2" id="brand">
                                                        <div class="form-group">
                                                            <label for="vname">Brand Name</label>
                                                    ...
                                                    <table id="example2" class="table table-bordered table-striped example1">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <?php if (($auth->verifyUserPermission('checked', 'brand_edit') == true) || ($auth->verifyUserPermission('checked', 'brand_del') == true) || $auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin')) { ?>
                                                                    <th>Action</th>
                                                                <?php } ?>
                            ...
                            success: (res) => {
                                ...
                                res.forEach((row, sl) => {
                                    const row1 = `<tr data-id="${row.N_ID}">
                                            ...
                                            <td align="center">
                                             <?php if ($auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin') || ($auth->verifyUserPermission('checked', 'brand_edit') == true)) { ?>
                                                ...
                                                <?php  } ?>
                                                <?php if ($auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin') || ($auth->verifyUserPermission('checked', 'brand_del') == true)) { ?>
