...
<div class="cell-md-12">
    <div data-role="panel" data-title-caption="Proceed for Purchase" data-collapsible="false" data-title-icon="<span class='mif-done_all'></span>">
        <div class="ml-1 mr-1">
            <table 
                class="table striped table-border cell-border subcompact mt-1 accessories-table-common purchasegm-workorder-table"
                data-role="table"
                ...
                data-cls-table-container="merchandiser-gm-workorder-table"
                data-source="data/merchandisergm-workorder.php"
                ...
                <tr>
                    ...
                    <td style="padding: 1px;"><button class="image-button success" type="button" onclick="workorderViewOperation('purchasegm-workorder-table', 'purchasegm', 'merchandisergmworkorder.php');" style="height: 22px; padding: 0 2px 0 0;"><span class="mif-done_all icon" style="height: 22px; line-height: 22px; font-size: .9rem; width: 20px;"></span><span class="caption" style="margin-left: 2px;">Checked by Purchase</span></button></td>
