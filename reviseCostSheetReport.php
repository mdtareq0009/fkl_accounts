...
MPM_TOTAL_MATERIAL_PRICE,MPM_TOTAL_CM_PRICE,MPM_TOTAL_CB_PRICE,MPM_PROFIT_PRICE,MPM_FOB_PRICE,MPM_UNIT_PRICE,MPM_TOTAL_PRICE,MPM_REMARKS,MPM_PRICE_DEFF,MPM_OFFER_PRICE,REVISE_STATUS,
...
within group(order by mpf.mpf_sl asc) AS fab_name from inv.mrd_precosting_fabric_rev mpf where mpf.mpmr_sl='$masterId') as fab_name,(select round(sum(mpf_cadcon),5) as cadcon FROM inv.mrd_precosting_fabric_rev cad where cad.mpmr_sl='$masterId') AS cadcon FROM inv.
MRD_PRECOSTING_MASTER_REV  MPM where mpm.mpmr_sl='$masterId'");
...
// (SELECT mip.mrd_item_pack_name FROM inv.mrd_item_pack mip WHERE mip.mrd_item_pack_id = MPM.MPM_PACK_TYPE) AS pack_type
// FROM inv.
// MRD_PRECOSTING_MASTER  MPM where  mpmr_sl='$masterId'");
...
<body>
	...
	<div class="ml-4 mr-4" id="content">
		...
		<div class="float-left m-0">
			<!-- <b>	 -->
                <!-- <div class="cell-md-6"> -->
			<table class="table row-border cell-border table-border subcompact" id="fabric">
				<tr>
				...
				<tr>
                    ...
                    <!-- <div class="row"> -->
                        <!-- <div class="cell-sm-4 cell-md-4 cell-lg-4" style="box-sizing: border-box;"> -->
	...
	<div class="float-right">
		...
		<table class="table table-border row-border cell-border subcompact">
			<tr>
				...
				<!-- <td>:</td> -->
				<td><strong><?php echo $queryResult[0]['MPM_NO']?> <span class="fg-red"><?php $revise = $queryResult[0]['REVISE_STATUS']+1; echo '(REV-'.$revise.')'; ?></span></strong></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<!-- <td>:</td> -->
				<td><?php echo $queryResult[0]['OFFERPRICE']?$queryResult[0]['OFFERPRICE']:round($queryResult[0]['MPM_OFFER_PRICE'],5); ?></td>
		...
		<div class="row">
			...
			<div class="float-right mt-5" style="width: 260px;margin-left:20px;">
				<table>
					...
					<?php
				$pic = $accessoriesModel->getData("select * from inv.MRD_PRECOSTING_PIC_REV where mpmr_sl='$masterId'");
	...
	<div class="float-left">
			...
			<caption align="center"><b>CM CONSUMPTION</b></caption>
				...
				<?php 
					...
					from inv.MRD_PRECOSTING_CM_REV MPC
					WHERE mpmr_sl='$masterId'");
					// echo '<pre>';
					// print_r($fabTable);
					// exit;
					$c = 0;
