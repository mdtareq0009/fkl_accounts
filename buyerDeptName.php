        ...
        <div class="navview-content h-100">
            ...
            <div class="content-inner h-100" style="overflow-y: auto">
                <div class="row border-bottom bd-lightGray pl-1 mr-1 ribbed-lightGray" style="margin-left: 0px;">
                    <div class="cell-md-4">
                        <h4 class="dashboard-section-title text-center text-left-md w-100 content-title-big" data-group="setting" data-page="<?=$pageOpt->currentPageClass()?>" style="font-size: 1.2rem; line-height: 1; font-weight: bold; text-shadow: 1px 1px 2px #fff;"><span class="icon"><span class="mif-cogs"></span></span> Department Name</h4>
                    </div>
                    <div class="cell-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="cell-md-4">
                            <div class="form-group">
                                <label>Department Name<span class="fg-red">*</span></label>
                                <input type="text" data-role="input" class="input-small required-field" name="buyerdeptname" id="buyerdeptname" placeholder="Enter Department Name" value="">
                        ...
                        <div class="cell-md-4">
                            <div class="cell-12 d-flex flex-justify-center mt-2">
                                <button type="text" name="style-submit" class="image-button rounded border bd-dark-hover success mr-2" onclick="insertDropdown('buyerdeptname','INV.MRD_BUYER_DEPT','MRD_BUYER_DEPT_ID','MRD_BUYER_DEPT_NAME','MRD_BUYER_DEPT_SL')">
