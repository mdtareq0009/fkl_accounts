...
if($auth->authUser()):
	if($auth->verifyUserPermission('costsheet', 1)):
        ...
        $fabricData = $accessoriesModel->getData("select * from inv.mrd_precosting_fabric where mpm_no='$masterId' order by mpf_sl asc");
        $accessoriesData = $accessoriesModel->getData("select * from inv.mrd_precosting_trim where mpm_no='$masterId' order by mpt_sl asc");
        $othersData = $accessoriesModel->getData("select * from inv.mrd_precosting_other where mpm_no='$masterId' order by mpo_sl asc");
        $imageData = $accessoriesModel->getData("select * from inv.mrd_precosting_pic where mpm_no='$masterId' order by mpp_sl asc");
        $costMarginData = $accessoriesModel->getData("select * from inv.mrd_precosting_cm where mpm_no='$masterId' order by mpc_sl asc");

        
        $seassionId = $masterData[0]['MRD_BUYER_SEASON_ID'];
        $seassonname = $accessoriesModel->getData("select vseassonname from erp.mer_seassonname where nseassoncode=$seassionId");
        $deptId = $masterData[0]['MRD_BUYER_DEPT_ID'];
        $deptname = $accessoriesModel->getData("select vdeptname from erp.mer_department where ndeptid=$deptId");
        // echo "<pre>";
    ...
    <div data-role="navview" data-toggle="#paneToggle" data-expand="xxl" data-compact="xl" data-active-state="true">
        ...
        <div class="input-small navview-content h-100">
            ...
            <div class="input-small content-inner h-100" style="overflow-y: auto">
                ...
                <h4 class="dashboard-section-title text-center text-left-md w-100 content-title-big" data-group="setting" data-page="<?php //echo $pageOpt->currentPageClass()?>" style="font-size: 1.2rem; line-height: 1; font-weight: bold; text-shadow: 1px 1px 2px #fff;"><span class="icon"><span class="mif-pencil"></span></span> Edit Cost Sheet</h4>
<!-- ================================Content======================================================== -->
                <!-- <form action="javascript:void()" method="post" id="form" onsubmit="return checkForm(this);"> -->
                <form action="costsheetSubmit.php?edit=update" method="post" onkeydown="return disableEnterSubmit(event)" id="form" name="form"  enctype="multipart/form-data" onsubmit="return checkForm(this);">
                <?php
                ...
                ?>
                    <table class="input-small table">
                        <tr>
                            ...
                            <select data-cls-drop-list="drop-width"  data-role="select"  name="buyer" id="buyer" class="input-small" data-filter-placeholder="Search Buyer..." onChange="getDepartment(this.value,'edit'),getSeasson(this.value,'edit');">
                            <?php echo $appsDependent->dropdownCommon('erp.mer_buyername', 'NBUYERID', 'VNAME', $masterData[0]['MPM_BUYER_ID']) ?>
                            </select>
                            ...
                            <?php echo '<option selected value='.$masterData[0]['MRD_BUYER_SEASON_ID'].'>' .$seassonname[0]['VSEASSONNAME']. '</option>' ?>
                            </select>
                        ...
                        <tr>
                            ...
                            <?php echo '<option selected value='.$masterData[0]['MRD_BUYER_DEPT_ID'].'>' .$deptname[0]['VDEPTNAME']. '</option>' ?>
                            </select>
                            ...
                            <?php //echo $appsDependent->dropdownCommon('inv.mrd_ITEM_PACK', 'MRD_ITEM_PACK_ID', 'MRD_ITEM_PACK_NAME', $masterData[0]['MPM_PACK_TYPE']) ?>
                            </select> -->
...
<!-- =================fab table======================== -->	
                    ...
                    <table  id="tblSample_fab" style="text-align: center;border-color: white" class="input-small table-border table cell-border row-border" >
                        <thead>
                    ...
                    <tr>
                        ...
                        <!-- <td>
                            <input readonly type="text" class="input-small ratioCls" value="<?php //echo $fabric['MPF_RATIO']; ?>" name="mpf_ratio[]" id="mpf_ratio" onKeyUp="rowCal_fab($(this));" onBlur="rowCal_fab($(this));"  autocomplete='off'>
                        </td>
	...
	<tr>	
		<td>
			...
			<input type="hidden" id="rowCount_trim" value="1" >		
				<table id="tblSample_trim" style="width:100%;text-align:center ;border-color: white" border="1" class="input-small table row-border cell-border">
                        <thead>
					...
					<tr>
						...
						<td><input type="text" class="input-small trimPriceCls"  name="mpt_trim_price[]" id="mpt_trim_price0" value="<?php echo $accessories['MPT_TRIM_PRICE'] ?>" onKeyUp="rowCal_trim($(this));"/></td>
		...
		<td>
			...
			<!-- performance table -->		
			<table id="tblSample_oc" style="width:100%;text-align: center;border-color: white" border="1" class="input-small table row-border cell-border" >
                            <thead>
                                <th class="input-small text-center">SL</th>
		...
		<td>
			...
			<!-- performance table -->		
			<table id="tblSample_pic" style="width:98%;border-color: white" border="1" class="input-small table row-border table-reiv" >
                            <thead>
                                <th class="input-small text-center">SL</th>
						...
						<tr>
							...
							<td>
                                ...
                                <img id="blah0" alt="your image" width="180" height="100" />
                            </td>
...
<!--================Cm table=========================== -->	
                ...
                <table id="tblSample_cm" style="width:100%;border-color:black" border="1" class="input-small table-border table cell-border row-border" >
					<thead>
						<th class="input-small text-center">SL</th>
						<th class="input-small text-center">Item<b style="color: red">*</b></th>
					...
					<tr>
						...
						<td><input type="text" class="input-small cmCls" name="mpc_cm[]" id="mpc_cm0" value="<?php echo $costmargin['MPC_CM'] ?>"	onKeyUp="cmToTotalCm()"/></td>
...
<!--================Grand Total table=========================== -->	
<hr>
<table width="100%" style="text-align: center" border="0" class="maingrid">
		<tr>
			...
			<td></td>
			<td>Confirm Price<b style="color: red">*</b> </td>
...
<br><hr>
        <div class="form-group text-center ">
            ...
            <button type="submit" name="updateButton" onkeydown="disableEnterSubmit(event)" id="myButton" class="button info rounded mb-4 mt-4" value="0">Update</button>
            <button type="submit" name="updateButton" onkeydown="disableEnterSubmit(event)" id="myButton" class="button success rounded mb-4 mt-4 mr-5" value="1">Publish</button>
...
function addRowToTable_Fab()
        ...
        function makeElement_fab(inputType,dynamicId,dynamicName){
                ...
                switch(InputType) {
                    ...
                    // case 'mpf_ratio': 			  
                    //     myHTML_Fab= "<input readonly type='text' class='input-small ratioCls' name='"+dynamicName+"[]' id='"+dynamicName+dynamicId+"' value='100' onKeyUp='rowCal_fab($(this));' onBlur='rowCal_fab($(this));' autocomplete='off'>";                  
                    // break;	
