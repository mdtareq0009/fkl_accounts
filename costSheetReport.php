...
MRD_BUYER_STYLE_ID AS BUYER_STYLE,
...
<body>
		...
		<!-- <div class="relative-div"> -->
			...
			<table class="table row-border cell-border table-border subcompact">
				...
				<thead>
					...
					<th class="text-center" style="max-width:35px">Item</th>
					<th class="text-center" style="max-width:30px">Fabrication</th>
					<th class="text-center" style="max-width:35px">Color</th>
	...
	<!-- <div class="cell-md-12 cell-sm-12"> -->
		<div class="row">
			<div class="float-left" style="width: 320px;max-width:320px;">
				<table class="table row-border cell-border table-border subcompact">
			...
			<!--other details-->
			<div class="float-left" style="width: 300px; max-width:300px; margin-left:20px;">
					<table class="table row-border cell-border table-border subcompact">
			...
			<div class="float-right mt-5" style="width: 260px;margin-left:20px;">
				...
				?>
					<img src="./reports/no_image.jpg" alt="No Image" class="mt-5" width="220" height="180" style="line-height: 0px;">
				<?php } ?>
				</table>
			</div>
		</div>
	...
	<div class="float-left">
			...
			<caption align="center"><b>CM CONSUMPTION</b></caption>
				...
				<?php 
					...
					WHERE MPM_NO='$masterId' order by MPC_SL asc");
					// echo '<pre>';
					// print_r($fabTable);
					// exit;
					$c = 0;
