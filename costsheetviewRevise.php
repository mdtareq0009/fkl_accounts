        ...
        <div class="navview-content h-100">
            ...
            <div class="content-inner h-100" style="overflow-y: auto">
                <div class="row border-bottom bd-lightGray pl-1 mr-1 ribbed-lightGray" style="margin-left: 0px;">
                    <div class="cell-md-4">
                        <h4 class="dashboard-section-title text-center text-left-md w-100 content-title-big" data-group="work-order" data-page="<?=$pageOpt->currentPageClass()?>" style="font-size: 1.2rem; line-height: 1; font-weight: bold; text-shadow: 1px 1px 2px #fff;"><span class="icon"><span class="mif-assignment"></span></span> Revise Cost Sheet</h4>
                    </div>
                    <div class="cell-md-8">
                    ...
                    <!-- <div class="container" id="print-js"> -->
                        ...
                        <!-- <table class="table row-border cell-border border row-hover cell-hover subcompact" data-rownum="true" data-role="table"> -->
                            ...
                            <thead>
                                ...
                                <th class="text-center sortable-column">Revise No.</th>						
                            ...
                            <?php
                                    $data=$accessoriesModel->getData("SELECT MPMR_SL,
...
as offerprice,published_status,revise_status,MPM_OFFER_PRICE,
                                ...
                                FROM inv.
                                    MRD_PRECOSTING_MASTER_REV  MPM WHERE DELETE_STATUS=0 AND (MPM_EUSER = '$userId'
                            ...
                            ?>
                                <tr class="text-center">
                                    ...
                                    <?php //if ($row['PUBLISHED_STATUS'] == 0 or $row['PUBLISHED_STATUS']== null ){ ?>
                                        <a onclick="publishData(this.id)" class="button small success fg-white rounded mif-done" id="<?php //echo $row['MPM_NO'] ?>"></a> 
                                        <?php //}else{ ?>
                                        <a class="button small warning fg-white rounded mif-done_all" id="<?php //echo $row['MPM_NO'] ?>"></a> 
                                        <?php //} ?>
                                    </td> -->
                                    <td class="text-center"><strong><?php echo $row['MPM_NO'] ?></strong> </td>
                                    <td class="text-center">
                                    <strong class="fg-blue"><?php echo 'REV-'.$row['REVISE_STATUS']+1; ?></strong>
                                          <!-- <small class="tally info" style="left: 140px;bottom: 10px;transform: rotate(-38deg);font-size: 11px;font-weight: bold; padding: 0 4px;">REV-<?php //echo $row['REVISE_STATUS']; ?></small> -->
                                    </td>
                                    <td class="text-center"><?php echo $row['MPM_CDATE'] ?></td>
                                    <td class="text-center"><?php echo $row['USER_NAME'] ?></td>
                                    <td class="text-center"><?php echo $row['BUYER_NAME'] ?></td>
                                    <td class="text-center"><a href="reviseCostSheetReport.php?master_id=<?php echo $row['MPMR_SL'] ?>" target="_blank"><?php echo $row['MRD_BUYER_STYLE_ID'] ?></a></td>
                                    ...
                                    <td class="text-center">
                                        <a href="reviseCostSheetReport.php?master_id=<?php echo $row['MPMR_SL'] ?>"  title="View Cost Sheet" target="_blank"><span class="mif-eye"></span></a>
