...
if($auth->authUser()):
	if($auth->verifyUserPermission('approved workorder', 2)):
		...
		listagg(items.ntotalqty,', ') within group (order by items.nid asc) as itemqty, 
