...
if($auth->authUser()):
	if($auth->verifyUserPermission('checked', 4)):
		...
		$data .= '{
		"name": "merchandiser",
		"title": "<input type=\'checkbox\' data-role=\'checkbox\' data-style=\'2\' onchange=\'allCheck(\"merchandiser-manager-workorder-table\", $(this))\' data-cls-check=\'bd-white\' data-cls-checkbox=\'all-checked\' data-caption=\'\'>",
		"size": 18,
		"clsColumn": "text-center",
		"cls": "text-center"
		},';
		...
		$data .= '"<a href=\'users.php?page=usersdetails&fklid='.$datarow['VMERCHANDISERMANAGERUSER'].'\'>'.$datarow['MANAGERUSER'].'</a>",';
        if($auth->verifyUserPermission('checked', 4)):
