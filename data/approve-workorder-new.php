...
if($auth->authUser()):
	if($auth->verifyUserPermission('checked', 9)):
        ...
        master.vordernumberorfklnumber, master.vtype, master.vpublisheduser, 
		employee.VEMPNAME AS createduser, master.vapproveduser,
        approvedemployee.VEMPNAME AS approveduser, master.vpublishedat, master.ncheckedstatus, master.vcheckeduser, 
		checkedby.VEMPNAME AS checkeduser,
        master.vmerchandiseruser,
		merchandiser.VEMPNAME as merchandiseruser,master.vmerchandisermanageruser,
		merchandisermanager.VEMPNAME as manageruser,
        master.vmerchandisergmuser,merchandisergm.VEMPNAME as merchandisergmruser,master.vpurchasegmuser,purchasegm.VEMPNAME as purchasegmuser,master.VAUDITUSER, audituser.VEMPNAME as audituser,
        ...
        LEFT JOIN hrm_employee merchandiser ON merchandiser.VEMPLOYEEID = master.vmerchandiseruser 
        LEFT JOIN hrm_employee merchandisermanager ON merchandisermanager.VEMPLOYEEID = master.vmerchandisermanageruser 
        LEFT JOIN hrm_employee merchandisergm ON merchandisergm.VEMPLOYEEID = master.vmerchandisergmuser 
        LEFT JOIN hrm_employee purchasegm ON purchasegm.VEMPLOYEEID = master.vpurchasegmuser
		LEFT JOIN hrm_employee audituser ON audituser.VEMPLOYEEID = master.vaudituser 
        ...
        master.vpurchasegmuser,purchasegm.empname,audituser.empname,vaudituser
