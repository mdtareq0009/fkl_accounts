...
?>
                ...
                <div class="content-wrapper" id="categories">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <ol class="breadcrumb float-sm-left">
                                        ...
                                        <li class="breadcrumb-item active" style="color: #ffdc2f;">Department</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="content">
                        <div class="container-fluid">
                            ...
                            if ($_GET['page'] == 'all-departments'):

                                if ($auth->verifyUserPermission('checked', 'department')
                                        ...
                                        <div class="col-md-12 col-lg-4 offset-lg-4">
                                            <div class="card card-secondary pt-2">
                                                ...
                                                <form id="departmentForm">
                                                    <div class="card-body p-2" id="department">
                                                        <div class="form-group">
                                                            <label for="vname">Department Name</label>
                                                            <input type="text" id="csrf" hidden  value="<?= $db->csrfToken() ?>" name="csrf" />
                                                            <input type="text" id="nid" hidden class="nid" name="N_ID" />
                                                            <input type="text" id="vname" class="form-control form-control-sm form-control-border vname" name="V_NAME" placeholder="Enter Department Name" />
                                                        </div>
                                                    ...
                                                    <table id="example2" class="table table-bordered table-striped example1">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <?php if (($auth->verifyUserPermission('checked', 'department_edit') == true) || ($auth->verifyUserPermission('checked', 'department_del') == true) || $auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin')) { ?>
                                                                    <th>Action</th>
                                                                <?php } ?>
                ...
                <script>
                        ...
                        $(document).on('click', '.deleteId', function() {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    let quaryType = 'delete-departments';
                                    let fd = new FormData();
                            ...
                            success: (res) => {
                                ...
                                res.forEach((row, sl) => {
                                    const row1 = `<tr data-id="${row.N_ID}">
                                            ...
                                            <td align="center">
                                             <?php if ($auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin') || ($auth->verifyUserPermission('checked', 'department_edit') == true)) { ?>
                                                ...
                                                <?php  } ?>
                                                <?php if ($auth->verifyUserPermission('role', 'super admin') || $auth->verifyUserPermission('role', 'admin') || ($auth->verifyUserPermission('checked', 'department_del') == true)) { ?>
                    ...
                    function editType(data) {
                        ...
                        $('#department .vname').val(rowData.V_NAME);
                        $('#department .nid').val(rowData.N_ID);
                    }
