        ...
        <div class="navview-content h-100">
            ...
            <div class="content-inner h-100" style="overflow-y: auto">
                <div class="row border-bottom bd-lightGray pl-1 mr-1 ribbed-lightGray" style="margin-left: 0px;">
                    <div class="cell-md-4">
                        <h4 class="dashboard-section-title text-center text-left-md w-100 content-title-big" data-group="setting" data-page="<?=$pageOpt->currentPageClass()?>" style="font-size: 1.2rem; line-height: 1; font-weight: bold; text-shadow: 1px 1px 2px #fff;"><span class="icon"><span class="mif-cogs"></span></span> Trim Name</h4>
                    </div>
                    <div class="cell-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="cell-md-4">
                            <div class="form-group">
                                <label>Trim Name<span class="fg-red">*</span></label>
                                <input type="text" data-role="input" class="input-small required-field" name="trimname" id="trimname" placeholder="Enter Trim Name" value="">
                                <span class="invalid_feedback">Trim name is required.</span>
                            </div>
                        </div>
                        <div class="cell-md-4"></div>
                        <div class="cell-md-4"></div>
                        <div class="cell-md-4">
                            <div class="cell-12 d-flex flex-justify-center mt-2">
                                <button type="text" name="style-submit" class="image-button rounded border bd-dark-hover success mr-2" onclick="insertDropdown('trimname','INV.MRD_TRIM','MRD_TRIM_ID','MRD_TRIM_NAME','MRD_TRIM_SL')">
